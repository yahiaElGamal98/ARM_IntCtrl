...
const IntCtrl_PRIGROUP_type ST_arr_PRIGROUPCfg[INTERRUPT_ARR_SIZE]={
   {INTCTRL_GPIO_PORTA                                      ,(((0)<<SHIFT_FACTOR)+(0))},  //(GROUP NUM 0-> 3)+(SUBGROUP NUM 0->1)
   {INTCTRL_GPIO_PORTB                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTC                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTD                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTE                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART0                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART1                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SSI0                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_I2C0                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM0_FAULT                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM_GEN0                                        ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM_GEN1                                        ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM_GEN2                                        ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_QEI0                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC_SEQUENCE0                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC_SEQUENCE1                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC_SEQUENCE2                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC_SEQUENCE3                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_WATCHDOG_T0_T1                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER0A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER0B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER1A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER1B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER2A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER2B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ANALOG_COMPARATOR0                              ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ANALOG_COMPARATOR1                              ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SYSTEM_CONTROL                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_FLASH_MEM_EEPROM_CTRL                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTF                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART2                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SSI1                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER3A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER3B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_I2C1                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_QEI1                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_CAN0                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_CAN1                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_HIBERNATION_MODULE                              ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_USB                                             ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM_GENERATOR3                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_DMA_SOFTWARE                                    ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_DMA_ERROR                                       ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC1_SEQUENCE0                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC1_SEQUENCE1                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC1_SEQUENCE2                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_ADC1_SEQUENCE3                                  ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SSI2                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SSI3                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART3                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART4                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART5                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART6                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_UART7                                           ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_I2C2                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_I2C3                                            ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER4A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER4B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER5A                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER5B                                         ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER0A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER0B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER1A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER1B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER2A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER2B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER3A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER3B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER4A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER4B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER5A_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_TIMER5B_32_64                                   ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_SYSTEM_EXCEPTION                                ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM1_GENERATOR0                                 ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM1_GENERATOR1                                 ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM1_GENERATOR2                                 ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM1_GENERATOR3                                 ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_PWM1_FAULT                                      ,(((0)<<SHIFT_FACTOR)+(0))}
};
#elif PRIGROUP_CONFIG_3
#define SHIFT_FACTOR 2
const uint8 prigroupVal=6;
const IntCtrl_PRIGROUP_type ST_arr_PRIGROUPCfg[INTERRUPT_ARR_SIZE]={
   {INTCTRL_GPIO_PORTA                                      ,(((0)<<SHIFT_FACTOR)+(0))},  //(GROUP NUM 0->1)+(SUBGROUP NUM0->3)
   {INTCTRL_GPIO_PORTB                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTC                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTD                                      ,(((0)<<SHIFT_FACTOR)+(0))},
   {INTCTRL_GPIO_PORTE                                      ,(((0)<<SHIFT_FACTOR)+(0))},
