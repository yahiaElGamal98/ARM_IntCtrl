...
const uint8 mem_pri=(MEM_PRIORITY&0x7);
const uint8 bus_pri=(BUS_PRIORITY&0x7);
const uint8 usage_pri=(USAGE_PRIORITY&0x7);
const uint8 svc_pri=(SVC_PRIORITY&0x7);
const uint8 debug_pri=(DEBUG_PRIORITY&0x7);
const uint8 pendsv_pri=(PENDSV_PRIORITY&0x7);
const uint8 tick_pri=(TICK_PRIORITY&0x7);
